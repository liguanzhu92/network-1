...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fexceptions', '-fstack-protector', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['pthread', 'dl', 'util', 'm', 'python2.6']
LIB_PYEXT = ['pthread', 'dl', 'util', 'm', 'python2.6']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/7/xujiab/nt/lab4/ns3/ns-3.24.1/build/src/fd-net-device', '/home/7/xujiab/nt/lab4/ns3/ns-3.24.1/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/home/7/xujiab/nt/lab4/ns3/ns-3.24.1/build']
...
VALGRIND_FOUND = True
VERSION = '3.24.1'
WITH_PYBINDGEN = '/home/7/xujiab/nt/lab4/ns3/pybindgen-0.17.0.post41+ngd10fa60'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/7/xujiab/nt/lab4/ns3/ns-3.24.1/build/ns3/config-store-config.h', '/home/7/xujiab/nt/lab4/ns3/ns-3.24.1/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
